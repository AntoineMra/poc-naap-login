        ...
        <div className="forms-page-container">
            <div className='forms-container'>
                ...
                <div className="radio-container" onChange={(e) => { SetRole(e.target.value) }}>
                    ...
                    <label for="NEUROATYPIQUE">Neuroatypique / Proche d’un.e neuroatypique <img src={ChevronR} alt="" className='form-input-icon-chevron' /></label>
                    ...
                    <label for="Curieux">Je suis curieux.se / Je m’informe <img src={ChevronR} alt="" className='form-input-icon-chevron' /></label>
                    ...
                    <label for="Professionel">Professionel.le de santé <img src={ChevronR} alt="" className='form-input-icon-chevron' /></label>
