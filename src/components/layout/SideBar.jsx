  ...
  return (
    <div className='sidebar'>
      ...
      <div className='reseaux'>
        <a href = "https://fr.linkedin.com/in/lo%C3%A9lia-galliez-6bb7981b4" target="_blank" > <img src ={Image} alt="Lien vers linkdeen de la boss" /></a>
        <a href = "https://www.instagram.com/" target="_blank"><img src ={Image} alt="Lien vers instagram" /></a>
        <a href = "https://fr-fr.facebook.com/" target="_blank"><img src ={Image} alt=" Lien vers " /></a>
      </div>
